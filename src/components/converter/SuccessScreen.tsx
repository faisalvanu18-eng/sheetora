...
export default function SuccessScreen({
  ...
  return (
    <div className="card p-8 text-center sm:p-12">
      ...
      <h2 className="mt-5 text-2xl font-bold">Your Excel file is ready</h2>
      ...
      <div className="mx-auto mt-5 max-w-sm rounded-xl border border-ink-200 bg-ink-50 p-4">
        ...
        <ul className="mt-3 space-y-1.5 text-left text-sm text-ink-600">
          <li className="flex items-center gap-2">
            <CheckCircle2 size={15} className="text-green-600" aria-hidden="true" /> Data extracted
          </li>
          <li className="flex items-center gap-2">
            <CheckCircle2 size={15} className="text-green-600" aria-hidden="true" /> Data reviewed
          </li>
          <li className="flex items-center gap-2">
            <CheckCircle2 size={15} className="text-green-600" aria-hidden="true" /> Excel generated
          </li>
        </ul>
      </div>
